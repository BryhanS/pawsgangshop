...
?>
    ...
    <section class="container">
      ...
      <p class="text-center">
        We offer a number of high quality toys to help keep <br> your pets healthy and spoiled!
      </p>
        ...
        <div class="row mb-3">
          ...
          <div class="categories__col sale col-md-8 col-sm-12 mb-3">
            <a href="#" class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative rounded overflow-hidden">
              ...
              <h2 class="position-absolute top-50 start-0 end-0 p-2 mb-0 text-center text-white" style="z-index: 2;">Special Offer</h2>
            </a>
          </div>
